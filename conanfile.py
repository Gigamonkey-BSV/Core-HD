...
class GigamonkeyConan (ConanFile):
    ...
    url = "https://github.com/Gigamonkey-BSV/core_hd"
    description = "Functions for working with Bitcoin core HD keys, as defined in BIP 32, 39, and 44"
    topics = ("Bitcoin", "HD")
    ...
    requires = [
        ...
        "gigamonkey/v0.0.14@proofofwork/stable",
        "argh/1.3.2",
        "gtest/1.12.1"
    ]
